...
namespace Drupal\ocha_reliefweb_chat\Plugin\ocha_reliefweb_chat\TextSplitter;

use Drupal\ocha_reliefweb_chat\Plugin\TextSplitterPluginBase;

/**
 * Split a text in groups of sentences.
 *
 * @OchaReliefWebChatTextSplitter(
 *   id = "sentence",
