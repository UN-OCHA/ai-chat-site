 ...
 */
class OchaAiChatDefaultSettingsForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    // @todo better way than harcoding this. This is mostly for the demo.
    $form['defaults']['plugins']['source']['url'] = [
      '#type' => 'url',
      '#title' => $this->t('Document source URL'),
      '#description' => $this->t('Optional document source URL, if relevant.'),
      '#default_value' => $defaults['plugins']['source']['url'] ?? NULL,
      '#maxlength' => 2048,
    ];
    $form['defaults']['plugins']['source']['limit'] = [
      '#type' => 'number',
      '#title' => $this->t('Document limit'),
      '#description' => $this->t('Maximum number of source documents to retrieve.'),
      '#default_value' => $defaults['plugins']['source']['limit'] ?? NULL,
    ];
  ...
  public function getFormId() {
    return 'ocha_ai_chat_default_settings_form';
  }
